...
BOOST_AUTO_TEST_CASE(mixed_characters)  
{
  BOOST_CHECK(A2R(12) == "XII");	
  BOOST_CHECK(A2R(53) == "LIII");	
  BOOST_CHECK(A2R(27) == "XXVII");
  BOOST_CHECK(A2R(531) == "DXXXI");
  BOOST_CHECK(A2R(206) == "CCVI");
  BOOST_CHECK(A2R(2025) == "MMXXV");
}
